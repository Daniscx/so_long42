...
/*   Updated: 2025/02/19 18:27:16 by dmaestro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c != '1')
		mlx_put_image_to_window(gm->mlx, gm->wnw, gm->sprite->backgroung, (x
				* 32), (y * 32));
	if (c == 'P')
	{
		mlx_put_image_to_window(gm->mlx, gm->wnw, gm->sprite->ply_right, (x
				* 32), (y * 32));
		gm->p_x = x;
		gm->p_y = y;
	}
	if (c == 'C')
		mlx_put_image_to_window(gm->mlx, gm->wnw, gm->sprite->rings, x * 32, y
			* 32);
	if (c == '1')
		mlx_put_image_to_window(gm->mlx, gm->wnw, gm->sprite->wall, x * 32, y
			* 32);
	if (c == 'E')
	{
		mlx_put_image_to_window(gm->mlx, gm->wnw, gm->sprite->exc0, x * 32, y
			* 32);
		gm->e_y = y;
		gm->e_x = x;
	}
